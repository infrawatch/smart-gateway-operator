...
# infra.watch/smart-gateway-operator-bundle:$VERSION and infra.watch/smart-gateway-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/infrawatch/smart-gateway-operator
